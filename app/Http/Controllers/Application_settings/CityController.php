...
class cityController extends Controller
{
  ...
  public function store(Storecity $request)
  {
    ...
    try
    {
        ...
        $cityes->id_governorate=$request->id_governoratees;
  ...
  public function update(Storecity $request)
  {
    ...
    if(isset($request->id_governoratees))
        {    
          $cityes->update([
          $cityes->name=['en'=>$request->name_en,'ar'=>$request->name_ar],
          $cityes->id_country=$request->id_country,
  ...
  {
      $governoratees = governorate::where("id_country", $id)->pluck("name", "id");
      return json_encode($governoratees);
  }
