...
class Create extends Component
{
    ...
    protected $messages = [
        ...
        'channel.required'       => 'قناة البيع مطلوبة.',
    ];
    ...
    public function updatedCountryId($val)
    {
        ...
        $this->city_id = '';
        $this->area_id = '';
        $this->governorates = $val
            ? governorate::where('country_id', $val)->orderBy('id','desc')->get()
            : collect();
        $this->cities = collect();
        $this->areas  = collect();
    }
    ...
    public function updatedGovernorateId($val)
    {
        ...
        $this->area_id = '';
        $this->cities = $val
            ? city::where('governorate_id', $val)->orderBy('id','desc')->get()
            : collect();
        $this->areas  = collect();
    }
    ...
    public function updatedCityId($val)
    {
        $this->area_id = '';
        $this->areas = $val
            ? area::where('city_id', $val)->orderBy('id','desc')->get()
            : collect();
    }
