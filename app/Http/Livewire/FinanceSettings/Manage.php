...
class Manage extends Component
{
    ...
    public $name = ['ar' => '', 'en' => ''];
    public $currency_id;
    public $cashbox_type = 'main'; // main | sub
    ...
    protected $messages = [
        ...
        'cashbox_type.in'            => 'قيمة نوع الخزينة غير صحيحة.',
    ...
    public function mount($id = null)
    {
        if ($id) {
            ...
            $this->cashbox_type       = $row->cashbox_type ?? 'main';
    ...
    {
        $this->userLimits[] = [
            'user_id' => null, 'daily_count_limit' => null, 'daily_amount_limit' => null,
            'require_supervisor' => false, 'active' => true
        ];
    }
