...
return [
    ...
    // ===== Manage ==    'manage_title' => 'إدارة المخزون',
    ...
    'manage_title' => 'إدارة المخزون',
    'manage_subtitle' => 'وصول سريع لوحدات وأدوات المخزون',
    'open' => 'فتح',
    'soon' => 'قريبًا',
    'route_missing' => 'المسار غير مفعّل',
  // صفحة إضافة مباشرة إلى المخزن
    'ds_title'         => 'إضافة مباشرة إلى المخزن',
    'ds_movement_date' => 'تاريخ الحركة',
    'ds_warehouse'     => 'المخزن',
    'ds_supplier'      => 'المورد',
    'ds_invoice_no'    => 'رقم الفاتورة',
    'ds_manual_ref'    => 'رقم الإضافة اليدوي',
    'ds_notes'         => 'ملاحظات',

    'ds_items_title'   => 'تفاصيل الأصناف',
    'ds_add_row'       => 'إضافة صف',
    'ds_product'       => 'الصنف',
    'ds_unit'          => 'الوحدة',
    'ds_qty'           => 'الكمية',
    'ds_expiry_date'   => 'تاريخ الانتهاء',
    'ds_batch_no'      => 'رقم التشغيلة',
    'ds_cost_price'    => 'سعر التكلفة',
    'ds_sale_price'    => 'سعر البيع',
    ...
    // Placeholders
    'ph_invoice'       => 'INV-001',
    'ph_manual_ref'    => 'REF-001',
    'ph_notes'         => 'ملاحظات اختيارية',
    'ph_batch_no'      => 'BATCH-001',
    // الكارد الجديد
