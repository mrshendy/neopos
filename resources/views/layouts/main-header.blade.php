            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{URL::asset('assets/images/logo.png')}}" alt="" height="17" style="height: 70px;width: 100%;">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-imgs"  @if(App::getlocale()=='en') src="{{URL::asset('assets/images/flags/us.svg')}}" @else src="{{URL::asset('assets/images/flags/eg.svg')}}"   @endif  alt="Header Language" height="20" class="rounded">
                    </button>
