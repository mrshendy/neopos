                    ...
                    <div class="card-header">
                       ...
                       {{-- Message --}}
                        ...
                        <div class="d-grid gap-2" >
                            <button data-bs-toggle="modal" data-bs-target="#signupModals" class="btn btn-primary waves-effect waves-light" type="button">{{ trans('settings_trans.add_new_city') }}</button>
                        </div>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModals{{$city->id}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</button></li>
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModal{{$city->id}}" class="dropdown-item edit-item-btn"> <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</button></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                          <!-- edit -->
                                          <div id="signupModals{{$city->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;" >
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('city.update','test')}}" method="post" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name_en" name="name_en" value="{{$city->getTranslation('name','en')}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">{{ trans('settings_trans.governorate_select') }}</label>
                                                                            <select id="id_governoratees" name="id_governoratees" class="form-control">
                                        ...
                                        <div id="signupModal{{$city->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    <div class="modal-header p-3">
