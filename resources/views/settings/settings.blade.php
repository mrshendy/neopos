            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <h4 class="card-title font">{{ trans('settings_trans.nationalities_settings') }}</h4>
                        <a href="{{ url('/' . $page='nationalities_settings') }}" class="btn btn-info">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <a href="{{ url('/' . $page='places_settings') }}" class="btn btn-info">
                            {{ trans('settings_trans.Go_to_settings_now') }}
                        </a>
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <a href="{{ url('/' . $page='currencies') }}" class="btn btn-info">
                            {{ trans('settings_trans.Go_to_settings_now') }}
                        </a>
                    </div>
                </div><!-- end col -->
                ...
                {{-- إعدادات الوحدات (بنفس شكل الباقي وزر أزرق) --}}
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        <div class="avatar-md mx-auto mb-3">
                            <div class="avatar-title bg-soft-light border border-info p-2 text-success rounded">
                        ...
                        <h4 class="card-title font">{{ trans('settings_trans.units_settings') }}</h4>
                        <a href="{{ route('units.index') }}" class="btn btn-info">
                            {{ trans('settings_trans.Go_to_settings_now') }}
                        </a>
                    </div>
                </div><!-- end col -->
