    ...
    <div class="col-12">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{ trans('settings_trans.area') }}</h5>
                       {{-- Message --}}
                        ...
                        <div class="d-grid gap-2" >
                            <button data-bs-toggle="modal" data-bs-target="#signupModals" class="btn btn-primary waves-effect waves-light" type="button">{{ trans('settings_trans.add_new_area') }}</button>
                        </div>
                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th data-ordering="false">{{ trans('settings_trans.name_city') }}</th>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModals{{$area->id}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</button></li>
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModal{{$area->id}}" class="dropdown-item edit-item-btn"> <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</button></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                          <!-- edit -->
                                          <div id="signupModals{{$area->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;" >
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    <div class="modal-header p-3">
                                                        <h4 class="card-title mb-0">{{ trans('settings_trans.update_area') }}</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('area.update','test')}}" method="post" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name_en" name="name_en" value="{{$area->getTranslation('name','en')}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">{{ trans('settings_trans.governorate_select') }}</label>
                                                                            <select id="id_governoratees" name="id_governoratees" class="form-control" onselect="get_city($(this).val())"
                                                                   ...
                                                                   <div class="col-md-4">
                                                                    <label class="my-1 mr-2" for="inlineFormCustomSelectPref">{{ trans('settings_trans.city_select') }}</label>
                                                                        <select id="id_city" name="id_city" class="form-control">
                                                                            <option value="" selected disabled>{{ trans('settings_trans.city_select') }}</option>
                                        ...
                                        <div id="signupModal{{$area->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    <div class="modal-header p-3">
                                                    ...
                                                    <div class="modal-body text-center p-5">
                                                        ...
                                                        <div class="mt-4 pt-4">
                                                            ...
                                                            <p class="text-muted">   {{ trans('settings_trans.massagedelete_p') }}{{$area->name}}</p>
                                                            <!-- Toogle to second dialog -->
                                                            <form action="{{ route('area.destroy','test')}}" method="post">
                                                                {{ method_field('delete') }}
                                                                {{ csrf_field() }}
                                                                <input  class="form-control" id="id" name="id" value="{{$area->id}}" type="hidden">

                                                            <button class="btn btn-warning" data-bs-target="#secondmodal" data-bs-toggle="modal" data-bs-dismiss="modal">
                                                                {{ trans('settings_trans.massagedelete_area') }}
                                                            </button>
                                                           </form>
                                                        </div>
                                                    </div>
        ...
        <div id="signupModals" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0">{{ trans('settings_trans.add_new_area') }}</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
