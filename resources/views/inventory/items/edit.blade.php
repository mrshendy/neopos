...
@section('title') {{ __('pos.inventory_products_title') }} @stop

@section('content')
<div class="page-wrap">
    <div class="d-flex align-products-center justify-content-between mb-3">
        <h4 class="mb-0"><i class="mdi mdi-pencil-outline me-2"></i> {{ __('pos.inventory_products_title') }}</h4>
    ...
    @livewire('inventory.products.edit', ['item_id' => request()->route('item')])
</div>
@endsection
