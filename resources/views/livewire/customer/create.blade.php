<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h4 class="mb-0"><i class="mdi mdi-account-plus-outline me-2"></i> {{ __('pos.title_customers_create') }}</h4>
        <a href="{{ route('customers.index') }}" class="btn btn-outline-secondary rounded-pill"><i
    ...
    <form wire:submit.prevent="save" class="card shadow-sm">
        <div class="card-body">
            <div class="row g-3">
                ...
                {{-- الدولة --}}
                <div class="col-md-3">
                    <label class="form-label fw-bold"><i class="mdi mdi-earth me-1"></i>
                        {{ __('pos.f_country') }}</label>
                ...
                {{-- المحافظة --}}
                <div class="col-md-3">
                    <label class="form-label fw-bold"><i class="mdi mdi-map me-1"></i>
                        {{ __('pos.f_governorate') }}</label>
