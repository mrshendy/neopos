                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select @error('country_id') is-invalid @enderror" wire:model="country_id">
                            ...
                            @foreach ($country as $rg)
                                @php
                                    $nm = method_exists($rg,'getTranslation')
                                        ? $rg->getTranslation('name', app()->getLocale())
                                        : ($rg->name ?? '');
                                @endphp
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select @error('governorate_id') is-invalid @enderror" wire:model="governorate_id">
                            ...
                            @foreach ($governorates as $go)
                                @php
                                    $nm = method_exists($go,'getTranslation')
                                        ? $go->getTranslation('name', app()->getLocale())
                                        : ($go->name ?? '');
                                @endphp
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control"
                               wire:model.defer="city" placeholder="{{ __('pos.ph_city_text') }}">
            ...
            <div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control"
                               wire:model.defer="phone" placeholder="{{ __('pos.ph_phone') }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control"
                               wire:model.defer="tax_number" placeholder="{{ __('pos.ph_tax') }}">
