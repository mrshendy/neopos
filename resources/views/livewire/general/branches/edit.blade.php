        ...
        <div class="col-12">
            <div class="card rounded-4 shadow-sm stylish-card">
                <div class="card-header bg-light fw-bold">
                    {{ __('branches.edit_title') }} — <span class="text-primary">{{ $branch->name }}</span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 field-block">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="statusSwitch" wire:model="status">
                ...
                <div class="card-footer d-flex gap-2">
                    <button class="btn btn-success rounded-pill px-4 shadow-sm" type="submit">
                        <i class="mdi mdi-content-save"></i> {{ __('branches.btn_update') }}
                    </button>
