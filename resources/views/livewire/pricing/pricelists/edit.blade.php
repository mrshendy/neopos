<div class="page-wrap">
    <h4 class="mb-3"><i class="mdi mdi-pencil-outline me-2"></i>{{ __('pos.price_lists_edit_title') ?? 'تعديل قائمة أسعار' }} #{{ $row->id }}</h4>
    ...
    <form wire:submit.prevent="update">
        ...
        <div class="mt-3 d-flex justify-content-between">
            ...
            <div class="d-flex gap-2">
                <button type="button" onclick="confirmDelete({{ $row->id }})" class="btn btn-outline-danger rounded-pill px-4 shadow-sm">
