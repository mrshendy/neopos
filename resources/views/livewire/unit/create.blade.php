    ...
    <div class="card border-0 shadow-lg rounded-4 stylish-card">
        <div class="card-body p-4">
            <form wire:submit.prevent="save" class="row g-4">
                ...
                {{-- الوصف عربي --}}
                <div class="col-md-6">
                    <label class="form-label fw-bold"><i class="mdi mdi-text-long"></i> {{ __('pos.description_ar') }}</label>
                ...
                {{-- الوصف إنجليزي --}}
                <div class="col-md-6">
                    <label class="form-label fw-bold"><i class="mdi mdi-text-long"></i> {{ __('pos.description_en') }}</label>
                ...
                {{-- المستوى --}}
                <div class="col-md-6">
                    <label class="form-label fw-bold"><i class="mdi mdi-view-grid-plus-outline"></i> {{ __('pos.level') }}</label>
                ...
                {{-- الحالة --}}
                <div class="col-md-6">
                    <label class="form-label fw-bold"><i class="mdi mdi-toggle-switch"></i> {{ __('pos.status') }}</label>
